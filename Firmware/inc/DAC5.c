...
// I.e., PortB has already been reset and activated (do not reset PortB here again)
     ...
     /* DAC GPIO Init - Ouputs */
     IOMUX->SECCFG.PINCM[PB0INDEX] = 0x00000081; //12 ohms
     IOMUX->SECCFG.PINCM[PB1INDEX] = 0x00000081; //6 ohms
     IOMUX->SECCFG.PINCM[PB2INDEX] = 0x00000081; //3 ohms
     IOMUX->SECCFG.PINCM[PB3INDEX] = 0x00000081; //1.5 ohms
     IOMUX->SECCFG.PINCM[PB4INDEX] = 0x00000081; //0.075 ohms

     uint32_t mask = 0b011111;
     GPIOB->DOE31_0|= mask;
