...
// I.e., PortB has already been reset and activated (do not reset PortB here again)
  IOMUX->SECCFG.PINCM[PB16INDEX] = 0x00050081; //Key 1: low freq
  IOMUX->SECCFG.PINCM[PB17INDEX] = 0x00050081; //Key 2
  IOMUX->SECCFG.PINCM[PB18INDEX] = 0x00050081; //Key 3
  IOMUX->SECCFG.PINCM[PB19INDEX] = 0x00050081; //Key 4: high freq
